...
class ThetaCalculator:
                ...
                for theta_6 in theta_6s:
                    ...
                    for theta_7 in theta_7s:
                        ...
                        for theta_4 in theta_4s:
                            theta_3s = self.calc_theta_3(
                                theta_1, theta_2, theta_4, theta_6, theta_7)
                            for theta_3 in theta_3s:
                                theta_5s = self.calc_theta_5(
                                    theta_1, theta_3, theta_4, theta_6, theta_7)
    ...
    def calc_theta_1(self, theta_2):
        ...
        c = -0.12*az*np.sin(theta_2) + pz*np.sin(theta_2) - \
            0.12*np.sin(theta_2) + 0.3
    ...
    def calc_theta_7(self, theta_1, theta_2, theta_6):
        ...
        c6c7 = -nz*np.sin(theta_2) - (nx*np.sin(theta_1) -
                                      ny*np.cos(theta_1))*np.cos(theta_2)
        c6s7 = -sz*np.sin(theta_2) - (sx*np.sin(theta_1) -
                                      sy*np.cos(theta_1))*np.cos(theta_2)
