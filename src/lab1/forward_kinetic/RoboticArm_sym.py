...
class RoboticArm:
    def __init__(self):
        ...
        self.a = sp.Matrix([0, 0, 0, 400, 400, 0, 0, 0])
        self.alpha = sp.Matrix([0, -sp.pi/2, -sp.pi/2, 0, 0, sp.pi/2, sp.pi/2, 0])
        self.d = sp.Matrix([0, 120, 100, 100, 100, 100, 100, 120])
    ...
    def calc_transform_matrix(self, index):
        ...
        """
        ct = sp.cos(self.theta[index+1] + self.offset[index+1])
        st = sp.sin(self.theta[index+1] + self.offset[index+1])
